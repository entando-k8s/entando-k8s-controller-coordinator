...
public class RawSimpleEntandoOperations implements SimpleEntandoOperations<SerializedEntandoResource> {
    ...
    public RawSimpleEntandoOperations(SimpleK8SClient<?> client, RawCustomResourceOperationsImpl operations) {
        this.client = client;
        this.operations = operations;
    }

    @Override
    public SimpleEntandoOperations<SerializedEntandoResource> inNamespace(String namespace) {
        return new RawSimpleEntandoOperations(client, operations.inNamespace(namespace));
    }

    @Override
    public SimpleEntandoOperations<SerializedEntandoResource> inAnyNamespace() {
        return new RawSimpleEntandoOperations(client, operations.inAnyNamespace());
    }

    @Override
    public void watch(EntandoResourceObserver<SerializedEntandoResource> observer) {
        try {
